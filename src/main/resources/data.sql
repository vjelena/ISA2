...
insert into sala values(3, 100, 'konfiguracija c', 'sala C', 1);
insert into sala values(4, 100, 'konfiguracija B', 'sala D', 4);
insert into sala values(5, 100, 'konfiguracija A', 'sala E', 1);
insert into sala values(6, 100, 'konfiguracija C', 'sala F', 2);
